...
import heroImg from "../../../assets/images/services/road-hero.jpg";
import logo from "../../../assets/logos/logo.png";
import logo2 from "../../../assets/logos/rassi.png";

export default function RoadSafetyHero() {
  return (
    <section
      id="road-safety-hero"
    ...
    >
      ...
      <div className="absolute inset-0">
        <img
          src={heroImg}
          alt="Road safety engineering and infrastructure assessment"
